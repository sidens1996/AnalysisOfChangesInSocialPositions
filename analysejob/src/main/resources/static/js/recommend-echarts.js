...
//     var datavalue = [15, 18, 19, 13, 12, 10, 8, 7, 10, 12, 15, 14, 14, 12, 13, 16, 18, 13, 15, 5];
//     var yMax = 20;
//     var dataShadow = [];
//
//     for (var i = 0; i < data.length; i++) {
...
//     });
    ...
    $("#recommend").click(function () {
        ...
        $.getJSON("/recommendResult?tags="+tags.substring(0,tags.length - 1)+"&words="+words.substring(0,words.length - 1), function (data) {
            myChart1.setOption({
                series: [{
